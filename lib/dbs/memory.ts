...
export async function hasStoreUser(storeHash: string, userId: string) {
    ...
    // eslint-disable-next-line no-console
    console.log(`Checking store user for storeHash: ${storeHash}, userId: ${userId} - Result: ${result}`);
...
export async function getStoreToken(storeHash: string) {
    ...
    // eslint-disable-next-line no-console
    console.log(`Getting store token for storeHash: ${storeHash} - Result: ${result}`);
